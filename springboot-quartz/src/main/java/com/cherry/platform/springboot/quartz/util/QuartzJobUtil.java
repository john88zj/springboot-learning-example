...
//    }
     ...
     */
    public void addJob(Class clazz, String jobName, String jobGroupName, String cronExpression) throws QuartzException {
    ...
    public void addJob(QuartzJob job) throws QuartzException {
        try {
            ...
            scheduler.start();
            //构建job信息
            JobDetail jobDetail = JobBuilder.newJob(((Job) job.getClazz().newInstance()).getClass()).withIdentity(job.getJobName(), job.getJobGroupName()).build();
            //表达式调度构建器(即任务执行的时间)
     ...
     * @param argMap
     */
    public void addJob(Class clazz, String jobName, String jobGroupName, String cronExpression, Map<String, Object> argMap) throws QuartzException {
        try {
            // 启动调度器
            scheduler.start();
            //构建job信息
     ...
     * @param cronExpression
     */
    public void updateJob(String jobName, String jobGroupName, String cronExpression) throws QuartzException{
     ...
     * @param argMap
     */
    public void updateJob(String jobName, String jobGroupName, String cronExpression, Map<String, Object> argMap) throws QuartzException {
        try {
     ...
     * @return
     */
    public List<Map<String, Object>> queryJob() throws QuartzException {
        GroupMatcher<JobKey> matcher = GroupMatcher.anyJobGroup();
        matcher.
        List<Map<String, Object>> jobList = new ArrayList<>();
        Set<JobKey> jobKeys = null;
